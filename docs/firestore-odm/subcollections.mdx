...
After [code generation](./code-generation.mdx), we can now access the sub-collection via the `usersRef`
reference:
...
more about usage of references, see the [using references](./references.mdx) documentation.
