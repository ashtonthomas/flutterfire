...
If you are looking to define a model as a reference on a Subcollection, read the [Working with Subcollections](./subcollections.mdx) documentation.
...
how to generate this code via the [Code Generation](./code-generation.mdx) documentation!
